...
import { IEventTarget } from "./target";
...
type THandler = (this: IEventTarget, request: IHttpRequest, response: IHttpResponse) => any;

export interface IServer extends IEventTarget {
    /**
