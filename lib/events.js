...
class ParseEvent extends HttpEvent {
    ...
    get body() {
        return this._args.features.get(kRequestBody)
    }

    set body(body) {
        this._args.features.set(kRequestBody, body)
    }
...
class SerializationEvent extends HttpEvent {
    ...
    get body() {
        return this._args.features.get(kResponseBody)
    }

    set body(body) {
        this._args.features.set(kResponseBody, body)
    }
